...
urlpatterns = [
    ...
    path("placeholder_api/users_detail/<int:pk>", views.users_detail, name="users_detail"),
    ...
    path("placeholder_api/users_update/<int:pk>", views.users_update, name="users_update"),
    path(
    ...
    path("placeholder_api/todos_detail/<int:pk>", views.todos_detail, name="todos_detail"),
    ...
    path("placeholder_api/todos_update/<int:pk>", views.todos_update, name="todos_update"),
    path(
    ...
    path("placeholder_api/albums_detail/<int:pk>", views.albums_detail, name="albums_detail"),
    ...
    path("placeholder_api/albums_update/<int:pk>", views.albums_update, name="albums_update"),
    path(
    ...
    path("placeholder_api/photos_detail/<int:pk>", views.photos_detail, name="photos_detail"),
    ...
    path("placeholder_api/photos_update/<int:pk>", views.photos_update, name="photos_update"),
    path(
    ...
    path("placeholder_api/posts_detail/<int:pk>", views.posts_detail, name="posts_detail"),
    ...
    path("placeholder_api/posts_update/<int:pk>", views.posts_update, name="posts_update"),
    path(
